...
├── models.py      # users / auth_states / sessions / friendships / messages / dm_reads / reactions / groups / group_members / group_reads 十张表
├── auth/          # 本地会话与鉴权依赖
